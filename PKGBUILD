...
package() {
    ...
    install -D -m755 "$srcdir/Aurin/data/askpass" "$pkgdir/$HOME/.aurin/askpass"
    ...
    install -D -m755 "$srcdir/Aurin/data/passprompt" "$pkgdir/$HOME/.aurin/passprompt"
    install -D -m755 "$srcdir/Aurin/data/runner" "$pkgdir/$HOME/.aurin/runner"
}
